    ...
    <script>
      var customLabel = {
        ...
        var infoWindow = new google.maps.InfoWindow;
          ...
          downloadUrl('get_all_address.php', function(data) {
            ...
            Array.prototype.forEach.call(markers, function(markerElem) {
              ...
              infowincontent.appendChild(document.createElement('br'));
              var latlng = document.createElement('text');
              latlng.textContent = "lat : "+latitude+" lng : "+longitude;
              infowincontent.appendChild(latlng);
